...
#connect tpice to normal cavity ramp, read this into this pitaya
#also trigger from scan red pitaya
...
from ColdMolpy.labdevices import RP
import numpy as np
import time
